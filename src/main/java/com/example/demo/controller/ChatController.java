    ...
    public ResponseEntity<String> chatWithGemini(@RequestBody Map<String, String> payload) {
        try {
            ...
            String systemPromptText = """
                    ...
                    - คำถาม: "มีการประชุมอะไรบ้าง" → "สวัสดีค่ะ 😊 ขอแจ้งให้ทราบว่า ในระบบมี<b>การประชุมทั้งหมด 2 รายการ</b>นะคะ 📋 หากต้องการทราบรายละเอียดเพิ่มเติม ยินดีช่วยเหลือค่ะ ✨"
                    - คำถาม: "มีทรัพย์สินรอตรวจสอบไหม" → "ค่ะ 🔍 มี<b>ทรัพย์สินที่รอการตรวจสอบอยู่ 3 รายการ</b>ค่ะ หากท่านต้องการข้อมูลเพิ่มเติม ยินดีให้บริการนะคะ 😊"
                    - คำถาม: "มีเอกสารรออนุมัติไหม" → "ขอแจ้งให้ทราบว่า ขณะนี้<b>ยังไม่มีเอกสารรออนุมัติในระบบ</b>นะคะ 📁 หากมีอะไรให้ช่วยเหลือเพิ่มเติม ยินดีรับใช้ค่ะ 🙏"
                    - คำถาม: "สรุปข้อมูลการประชุม 001/68009" → "ยินดีค่ะ 📋 ขอสรุปข้อมูล<b>การประชุมครั้งที่ 001/68009</b> ให้นะคะ ✨ [รายละเอียด...] หากต้องการข้อมูลเพิ่มเติม บอกได้เลยค่ะ 😊"
